					...
					<div class="row">
					  ...
					  <div class="col-lg-12">
						<div class="p-5">
						  ...
						  <!-- Formulário de Registro (PHP: tabela.php) -->
						  <form name="form" class="text-center user needs-validation" method="POST" action="tabela.php">
							<div class="form-group">
								<label>Codigo do Cliente</label>
							  <input type="text" name="codigo" maxlength="100" class="form-control" placeholder="codigo" required>
							</div>
							<br>

...
<!-- TELA DE MENU LATERAL---
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.html">
          <i class="fas"><img src=" "></i>
          <span>Cadastro de Clientes</span></a>
      </li>
      <!-- Inventaroio do Cliente -->
      <li class="nav-item ">
        <a class="nav-link" href="index.html">
          <i class="fas"><img src=" "></i>
          <span>Inventário</span></a>
      </li>
      <!-- CLIENTES ATIVOS -->
      <li class="nav-item ">
        <a class="nav-link" href="index.html">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="index.html">
          <i class="fas"><img src=" "></i>
          <span>Contabiliada</span></a>
      </li>

      <!-- item de Quadrinhos -->
      <li class="nav-item ">
        <a class="nav-link" href="registros.php">
          <i class="fas"><img src="cinema.png"></i>
          <span>usúario</span></a>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">Projeto teste De cadasro</h1>
          </div>

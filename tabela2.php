...
$site=filter_input(INPUT_POST, 'link', FILTER_SANITIZE_STRING);
...
if (isset($_POST['registraform']) && !empty($_POST['cpf'])) {
	...
	if ($V->ValidarCpf($cpf) == true) {
		//consultar no banco se o CPF já foi cadastrado
			...
			$result_usuario = "INSERT INTO cadastro ( codigo,empresa,endereco,cep,bairro,municipio,uf,link,telefone,email,email2,im,ie,cnpj,situacao ) VALUES('$codigo','$empresa','$endereco','$cep','$municipio','$bairro','$uf','$link','$telefone','$email','$email2','$im','$ie','$cnpj',$situacao')";
...
$result_usuario = "INSERT INTO cadastro ( codigo,empresa,endereco,cep,bairro,municipio,uf,link,telefone,email,email2,im,ie,cnpj ) VALUES ('$codigo','$empresa','$endereco','$cep','$municipio','$bairro','$uf','$link','$telefone','$email','$email2','$im','$ie','$cnpj,'";
